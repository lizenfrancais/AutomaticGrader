def main():
    print("Welcome to the Level 2 Writing Automatic Grader")
    ...
    while start_auto_grader.startswith("y"):
        ...
        print("Thank you for using the Level Two Writing Automatic Grader")
        print("....................................")
...
def varietyFunc(w):
    ...
    details = input("Enter detail level: very, somewhat, little, none ").lower()

    beyondMinimum = writtenWords / w

    if beyondMinimum > 1:
        beyondMinimum = 1
    else: beyondMinimum = beyondMinimum

    if details.startswith("l") or details.startswith("n"):
        return 3 * beyondMinimum
    else: return 4 * beyondMinimum 
...
def howWellUnderstoodFunc(ts):
    ...
    return ((ts - ((confusion + english) * .3)) / ts) * 4
